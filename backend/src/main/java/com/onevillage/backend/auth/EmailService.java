...
public class EmailService {
    ...
    public void sendCommunityInvitationEmail(String toEmail, String inviterName, String communityName, String communityId) {
        ...
        String plainText = "Bonjour,\n\n"
                ...
                + "Pour valider votre adhésion et participer aux sorties conviviales, chaque nouveau membre règle une contribution unique de 20 $ CAD.\n"
                ...
                + "bouffe@newvillages.ca (Dépôt automatique activé)\n\n"
                + "Ouvrez ce lien pour découvrir le groupe et finaliser votre adhésion :\n"
                + inviteLink + "\n\n"
        ...
        String htmlContent = "<div style=\"font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; border: 1px solid #efe6dd; border-radius: 16px; background-color: #ffffff;\">"
                ...
                + "</div>"
                + "<div style=\"background-color: #FAF5EF; border-radius: 12px; padding: 20px; margin-bottom: 20px; border: 1px solid #EFE6DD;\">"
                ...
                + "<div style=\"background-color: #ffffff; border: 1px solid #E86225; border-radius: 10px; padding: 14px; margin: 16px 0;\">"
                + "<p style=\"font-weight: bold; color: #E86225; margin: 0 0 6px 0; font-size: 14px;\">Paiement par Virement Interac seulement (20 $ CAD)</p>"
                + "<p style=\"font-size: 13px; color: #52433B; margin: 0 0 8px 0; line-height: 1.4;\">Copiez l’adresse courriel ci-dessous, puis quittez cette page pour effectuer le paiement dans votre compte bancaire :</p>"
                + "<p style=\"font-family: monospace; font-size: 14px; font-weight: bold; color: #133820; margin: 0; background: #E8F3EB; padding: 8px 12px; border-radius: 6px; display: inline-block;\">bouffe@newvillages.ca</p>"
                + "<p style=\"font-size: 11px; color: #1E4D2B; margin: 6px 0 0 0;\">Dépôt automatique activé &bull; Aucune question de sécurité requise</p>"
                + "</div>"
