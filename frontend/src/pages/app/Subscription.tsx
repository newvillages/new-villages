  ...
  const defaultPlans = [
    {
      ...
      features: [
        ...
        'Adhésion aux groupes : 20 $ CAD / groupe (validation admin)',
      ],
    },
    {
      id: 'leader',
      label: 'Organisateur de groupe (Leader)',
      price: '50 $',
      priceRaw: 50,
      period: '',
      ...
      features: [
        ...
        'Créer et administrer vos propres groupes',
        'Organiser des sorties au restaurant',
        'Rejoindre d\'autres groupes comme membre : 20 $ CAD',
      ],
    },
    {
      id: 'org',
      label: 'Organisation / Resto',
      price: '100 $',
      priceRaw: 100,
      period: '',
  ...
  const plans =
    dynamicPlans && dynamicPlans.length > 0
      ? dynamicPlans.map((p) => ({
          ...
          priceRaw: p.price,
          period: p.price === 0 ? '' : (p.billingPeriod ? `/${p.billingPeriod}` : ''),
          tag: p.tag || '',
